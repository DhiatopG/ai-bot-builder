...
export default function MakeBotListPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">
              Choose a bot to manage Make integration
            </h1>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Select from your professional automation bots to configure Make integrations 
        ...
        <div className={`grid gap-6 ${
          ...
          {bots.map((bot) => (
            ...
            >
              ...
              <Link href={`/dashboard/integrations/make/${bot.id}`}>
                <button
